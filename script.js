...
function createBandImage(band) {
  const image = document.createElement("img");
  image.classList.add("band-img");
...
bands.forEach((band) => {
  ...
  productsLink.classList.add("Bio");
