  ...
  modal.innerHTML = `
    ...
    <div class="admin-product-editor-box">
      ...
      >
        ...
        <div class="admin-product-form-field">
          <label for="adminProductMaterial">
            MATERIAL
          </label>
  ...
  visible.forEach((product) => {
    ...
    card.innerHTML = `
      <div class="admin-product-image">
        ...
        <span
          class="admin-product-active-badge ${active ? "" : "inactive"
      }"
        >
...
async function handleProductSubmit(
  ...
  */
  ...
  try {
    ...
    /*
      Product price remains useful
      as a base/fallback price.

      The real variant prices are
      stored in product_variants.
    */
